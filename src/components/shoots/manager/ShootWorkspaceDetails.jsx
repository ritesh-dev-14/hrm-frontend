                  ...
                  <div className="border-t border-slate-100 pt-5">
                    ...
                    {subtasks.length === 0 ? (
                      ...
                      <div className="space-y-4">
                        {subtasks.map((sub) => {
                          const hasSubmission = sub.submissionLinks && sub.submissionLinks.length > 0;
                          const hasIssue = !!sub.unableToSubmitReason;
                          ...
                          return (
                            <div key={sub.id} className="p-4 bg-white border border-slate-200 rounded-xl hover:border-indigo-100 shadow-sm transition flex flex-col justify-between gap-4 relative group">
                              ...
                              <div className="flex flex-col sm:flex-row justify-between items-start gap-3 pr-16">
                                  ...
                                  <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    {hasSubmission ? (
                                      ...
                                      <span className="inline-flex items-center gap-1 text-[9px] font-bold bg-rose-50 text-rose-700 border border-rose-100 px-2 py-0.5 rounded">
                                        <AlertOctagon size={10} /> Delivery Blocked
                                      </span>
                                    ) : (
                                ...
                                {/* Dynamic Setup Type Label Block */}
                                {sub.setupType && (
                              ...
                              {/* Error Warning Callout Strip */}
                              {hasIssue && (
                                <div className="p-2.5 bg-rose-50/60 text-rose-700 rounded-lg border border-rose-100 text-xs flex items-start gap-2 leading-relaxed">
                                  <AlertOctagon size={14} className="shrink-0 mt-0.5 text-rose-500" />
                                  <div>
                                    <span className="font-bold block text-[11px] uppercase tracking-wider text-rose-800">Unable To Submit Context Log:</span>
                              ...
                              <div className="space-y-2 pt-1">
                                ...
                                {/* Deliverable Submission Links Vector Matrix */}
                                {hasSubmission && (
