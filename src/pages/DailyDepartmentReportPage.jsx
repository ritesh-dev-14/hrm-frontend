                  ...
                  <div key={project.projectId} className="border border-gray-100 bg-white rounded-lg p-5 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-4 pb-4 border-b border-gray-50">
                      <div>
                        ...
                        {project.clientContactNumber && <p className="text-sm text-gray-500">Contact No.: <span className="font-medium font-mono text-gray-700">{project.clientContactNumber}</span></p>}
                      </div>
                  ...
                  <div key={project.projectId} className="border border-gray-100 bg-white rounded-lg p-5 shadow-sm">
                    ...
                    {project.report.hasReport ? (
                      <div className="space-y-2 text-sm mt-4 border-t border-gray-50 pt-4">
                        {project.report.clientName && <p className="flex justify-between"><span className="text-gray-500">Client:</span> <span className="font-medium">{project.report.clientName}</span></p>}
                        {project.report.clientContactNumber && <p className="flex justify-between"><span className="text-gray-500">Contact No.:</span> <span className="font-medium font-mono">{project.report.clientContactNumber}</span></p>}
