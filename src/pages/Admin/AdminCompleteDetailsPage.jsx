      ...
      if (res?.data?.success && res?.data?.data) {
        ...
        try {
          const sheetRes = await API.get(
            `/api/projects/${fullProj.id}/monthly-sheets`,
          );
        ...
        if (fullProj?.department?.name?.toLowerCase().includes("seo")) {
          try {
            const seoRes = await API.get(
              `/api/seo-reports?projectId=${fullProj.id}`,
            );
          ...
          if (shootRes?.data?.success) {
            ...
            const matching = (shootRes.data.data || []).filter(
              (w) =>
                w.title
                  ?.toLowerCase()
                  .includes(fullProj.projectName.toLowerCase()) ||
                w.projectName
                  ?.toLowerCase()
                  .includes(fullProj.projectName.toLowerCase()),
            );
            setShootWorkspaces(
              matching.length > 0 ? matching : shootRes.data.data || [],
            );
          }
        } catch (e) {
          setShootWorkspaces([]);
          ...
          <div className="bg-white rounded-3xl max-w-5xl w-full max-h-[90vh] shadow-2xl border border-slate-200 flex flex-col overflow-hidden animate-fadeIn my-auto">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-300 flex items-center gap-3 flex-wrap">
                    ...
                    {selectedProject.phone && (
                      <span>Contact: {selectedProject.phone}</span>
                    )}
                    {selectedProject.location && (
                      <span>Loc: {selectedProject.location}</span>
                    )}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-slate-100 px-6 py-2 border-b border-slate-200 flex items-center gap-2 overflow-x-auto scrollbar-none shrink-0">
              {[
                ...
                {
                  id: "content_calendar",
                  label: "Content Calendar & Mood Board",
                  icon: FileSpreadsheet,
                },
                {
                  id: "shoots",
                  label: "Shoot Schedules & Tasks",
                  icon: Camera,
                },
                {
                  id: "reports",
              ...
              {detailLoading ? (
                <div className="py-20 text-center space-y-3">
                  ...
                  <p className="text-sm font-semibold text-slate-600">
                    Gathering full project context...
                  </p>
                </div>
              ) : (
                <>
                    ...
                    <div className="space-y-6 animate-fadeIn">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-1">
                          ...
                          <p className="text-base font-bold text-indigo-600">
                            {formatDate(selectedProject.renewalDate)} (
                            {selectedProject.frequency || "Monthly"})
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2 border-b pb-3">
                          <User size={16} className="text-indigo-600" /> Client
                          & Contact Details
                        </h4>
                  ...
                  {activeTab === "credentials" && (
                    <div className="space-y-6 animate-fadeIn">
                      <div className="bg-amber-50 rounded-2xl p-4 border border-amber-200 text-amber-800 text-xs flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-bold">
                            Confidential Administrative Credentials
                          </p>
                          <p className="text-amber-700">
                            All passwords and access tokens are restricted
                            strictly for administrative management.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2 border-b pb-3">
                          <Globe size={16} className="text-violet-600" /> Social
                          Media Credentials
                        </h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                          ...
                          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                              ...
                              <div className="flex items-center justify-between bg-white p-2 rounded-lg border">
                                <span className="font-mono">
                                  {selectedProject.fbEmail ||
                                    selectedProject.facebookUsername ||
                                    "N/A"}
                                </span>
                                {selectedProject.fbEmail && (
                                  <button
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center justify-between bg-white p-2 rounded-lg border">
                                <span className="font-mono">
                                  {showPasswords.fb
                                    ? selectedProject.fbPassword || "N/A"
                          ...
                          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center justify-between bg-white p-2 rounded-lg border">
                                <span className="font-mono">
                                  {showPasswords.insta
                                    ? selectedProject.instaPassword || "N/A"
                          ...
                          {(selectedProject.linkedinEmail ||
                            ...
                            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2 md:col-span-2">
                              <p className="font-bold text-slate-800 text-sm">
                                Other Channels (LinkedIn / YouTube / Twitter)
                              </p>
                      ...
                      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2 border-b pb-3">
                          <Globe size={16} className="text-blue-600" /> Web
                          Development Credentials & Domain Details
                        </h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                          ...
                          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center justify-between bg-white p-2 rounded-lg border">
                                <span className="font-mono">
                                  {selectedProject.domainName || "N/A"}
                                </span>
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center justify-between bg-white p-2 rounded-lg border">
                                <span className="font-mono">
                                  {showPasswords.domain
                                    ? selectedProject.domainPassword || "N/A"
                                ...
                                {selectedProject.domainPassword && (
                                  <button
                                    onClick={() => togglePasswordView("domain")}
                                    className="text-slate-400 hover:text-slate-600"
                                  >
                                    {showPasswords.domain ? (
                                      <EyeOff size={13} />
                          ...
                          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center justify-between bg-white p-2 rounded-lg border">
                                <span className="font-mono">
                                  {selectedProject.clientEmail || "N/A"}
                                </span>
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center justify-between bg-white p-2 rounded-lg border">
                                ...
                                {selectedProject.clientEmailPassword && (
                                  <button
                                    onClick={() =>
                                      togglePasswordView("clientEmailPass")
                                    }
                                    className="text-slate-400 hover:text-slate-600"
                                  >
                                    {showPasswords.clientEmailPass ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                          ...
                          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                            ...
                            <div className="flex items-center justify-between bg-white p-2 rounded-lg border">
                              <span className="font-mono">
                                {showPasswords.seo
                                  ? selectedProject.seoPassword || "N/A"
                              ...
                              {selectedProject.seoPassword && (
                                <button
                                  onClick={() => togglePasswordView("seo")}
                                  className="text-slate-400 hover:text-slate-600"
                                >
                                  {showPasswords.seo ? (
                                    <EyeOff size={13} />
                          ...
                          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                            <span className="text-slate-400 font-semibold block">
                              SEO Representative / Contact Name:
                            </span>
                            <p className="font-bold text-slate-800 text-sm bg-white p-2 rounded-lg border">
                              {selectedProject.seoName || "N/A"}
                            </p>
                          </div>
                          ...
                          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                            ...
                            <p className="font-bold text-slate-800 text-sm bg-white p-2 rounded-lg border">
                              {selectedProject.seoContact || "N/A"}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="space-y-1">
                          <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2">
                            ...
                            Project Mood Board & Creative References
                          </h4>
                          <p className="text-xs text-slate-500">
                            Visual direction, design aesthetic, references, and
                            taste board for creative team.
                          </p>
                        </div>
                        {monthlySheets[0]?.moodBoardLink ? (
                          ...
                          <span className="text-xs text-slate-400 italic">
                            No mood board link registered yet
                          </span>
                        )}
                      </div>
                      ...
                      {monthlySheets.length > 0 ? (
                          ...
                          >
                            <div className="flex items-center justify-between border-b pb-3">
                              <h4 className="text-sm font-bold text-slate-900">
                                Monthly Content Sheet — Month {sheet.month}/
                                {sheet.year}
                              </h4>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                                <div className="flex items-center justify-between text-xs font-bold">
                                  ...
                                  <span>
                                    {sheet.totalReelsUploaded || 0} /{" "}
                                    {sheet.totalReels || 0} Uploaded
                                  </span>
                                </div>
                              ...
                              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                                <div className="flex items-center justify-between text-xs font-bold">
                                  ...
                                  <span>
                                    {sheet.totalPostsUploaded || 0} /{" "}
                                    {sheet.totalPosts || 0} Uploaded
                                  </span>
                                </div>
                                <div className="w-full h-2 rounded-full bg-slate-200 overflow-hidden">
                                  <div
                            ...
                            {sheet.days && sheet.days.length > 0 && (
                              <div className="pt-4 space-y-2">
                                <p className="text-xs font-bold uppercase tracking-wider text-slate-400">
                                  Scheduled Daily Deliverables (
                                  {sheet.days.length} Days)
                                </p>
                        ...
                        <div className="bg-white p-12 rounded-2xl border border-slate-200 text-center space-y-2">
                          ...
                          <p className="font-bold text-slate-700">
                            No Content Calendar Sheets Found
                          </p>
                          <p className="text-xs text-slate-500">
                            No monthly content sheets have been published for
                            this project yet.
                          </p>
                        </div>
                      )}
                  ...
                  {activeTab === "shoots" && (
                    <div className="space-y-6 animate-fadeIn">
                      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2 border-b pb-3">
                          <Camera size={16} className="text-indigo-600" /> Shoot
                          Workspaces & Media Schedules
                        </h4>
                        ...
                        {shootWorkspaces.length > 0 ? (
                                ...
                                {ws.shootTasks && ws.shootTasks.length > 0 ? (
                                  <div className="space-y-2 text-xs">
                                    ...
                                    {ws.shootTasks.map((st) => (
                                      <div
                                        key={st.id}
                                        className="bg-white p-2.5 rounded-lg border space-y-1"
                                      >
                                        ...
                                        <div className="flex items-center justify-between text-slate-500 text-[11px]">
                                          <span>
                                            Date: {st.date || "TBD"} (
                                            {st.arrivalTime || "Time TBD"})
                                          </span>
                                          <span>
                                            Loc: {st.location || "On Site"}
                                          </span>
                                        </div>
                                  ...
                                  <p className="text-xs text-slate-500 italic">
                                    No specific shoot tasks listed yet.
                                  </p>
                                )}
                              </div>
                            ))}
                          ...
                          <div className="p-8 text-center space-y-2">
                            ...
                            <p className="text-xs text-slate-500">
                              There are no shoot tasks or media schedules
                  ...
                  {activeTab === "reports" && (
                    <div className="space-y-6 animate-fadeIn">
                      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2 border-b pb-3">
                          <TrendingUp size={16} className="text-emerald-600" />{" "}
                          SEO Monthly Growth & Audit Reports
                        </h4>
                        ...
                        {seoReports.length > 0 ? (
                              ...
                              >
                                <div className="flex items-center justify-between">
                                  <span className="font-bold text-slate-900 text-sm">
                                    Report Month: {rep.month}/{rep.year}
                                  </span>
                                ...
                                <p className="text-slate-600">
                                  {rep.remarks ||
                                    "Regular monthly search audit report."}
                                </p>
                                {rep.reportFile && (
                                  <a
                                    href={rep.reportFile}
                          ...
                          <div className="p-8 text-center space-y-2">
                            ...
                            <p className="text-xs text-slate-500">
                              No monthly SEO audits or report documents
